...
export default function LoginForm() {
  ...
  return (
    <div
      className={`${roboto.className} ${styles.itemsStartOnShortScreen} relative z-10 flex h-4/6 w-1/2 max-w-screen-md items-center justify-center overflow-y-auto rounded-2xl bg-primary py-9 max-[1023px]:w-3/4 max-[434px]:w-full`}
    >
      <button onClick={handleBack}>
        <ArrowUturnLeftIcon className='absolute left-4 top-5 w-6 hover:scale-110' />
      </button>
      <form
        action={formAction}
